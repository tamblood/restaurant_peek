...
class Restaurant < ActiveRecord::Base
  ...
  def cheese_board_scraper
    ...
    date_tues = doc.xpath('//*[@id="body"]/div/div[2]/div[1]/h4[1]').text
    pod_tues = doc.xpath('//*[@id="body"]/div/div[2]/div[1]/p[1]').text

    date_wed = doc.xpath('//*[@id="body"]/div/div[2]/div[1]/h4[2]').text
    pod_wed = doc.xpath('//*[@id="body"]/div/div[2]/div[1]/p[2]').text

    date_thurs = doc.xpath('//*[@id="body"]/div/div[2]/div[1]/h4[3]').text
    pod_thurs = doc.xpath('//*[@id="body"]/div/div[2]/div[1]/p[3]').text

    date_fri = doc.xpath('//*[@id="body"]/div/div[2]/div[1]/h4[4]').text
    pod_fri = doc.xpath('//*[@id="body"]/div/div[2]/div[1]/p[4]').text

    date_sat = doc.xpath('//*[@id="body"]/div/div[2]/div[1]/h4[5]').text
    ...
    if today.wday == 1 || today.wday == 7
      ...
      special_of_day = week_pizza[today.wday - 1][0]
    end
